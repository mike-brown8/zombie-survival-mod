...
package net.mcreator.mzs.entity;
...
import net.mcreator.mzs.entity.renderer.ZombiePlayerRenderer;
import net.mcreator.mzs.MzsModElements;

@MzsModElements.ModElement.Tag
public class ZombiePlayerEntity extends MzsModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("zombie_player").setRegistryName("zombie_player");

	public ZombiePlayerEntity(MzsModElements instance) {
		super(instance, 2);
		FMLJavaModLoadingContext.get().getModEventBus().register(new ZombiePlayerRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13382401, -13369396, new Item.Properties().group(MikesZombieSurvivalItemGroup.tab))
				.setRegistryName("zombie_player_spawn_egg"));
	}
