...
public class ZombieSoldierEntity extends MzsModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.6f, 1.8f)).build("zombie_soldier").setRegistryName("zombie_soldier");

	public ZombieSoldierEntity(MzsModElements instance) {
		super(instance, 3);
		FMLJavaModLoadingContext.get().getModEventBus().register(new ZombieSoldierRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13382401, -52429, new Item.Properties().group(MikesZombieSurvivalItemGroup.tab))
				.setRegistryName("zombie_soldier_spawn_egg"));
	}

	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(entity, 25, 4, 4));
	}
